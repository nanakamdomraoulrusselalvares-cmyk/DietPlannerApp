...
import com.guyanne.dietplanner.data.local.dao.MealDao_DietDatabase_Impl;
import com.guyanne.dietplanner.data.local.dao.ShoppingItemDao;
import com.guyanne.dietplanner.data.local.dao.ShoppingItemDao_DietDatabase_Impl;
...
public final class DietDatabase_Impl extends DietDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(MealDao.class, MealDao_DietDatabase_Impl.getRequiredConverters());
    _typeConvertersMap.put(ShoppingItemDao.class, ShoppingItemDao_DietDatabase_Impl.getRequiredConverters());
  ...
  public MealDao mealDao() {
    if (_mealDao != null) {
      ...
      synchronized(this) {
        if(_mealDao == null) {
          _mealDao = new MealDao_DietDatabase_Impl(this);
        }
        return _mealDao;
      }
    }
  ...
  public ShoppingItemDao shoppingItemDao() {
    if (_shoppingItemDao != null) {
      ...
      synchronized(this) {
        if(_shoppingItemDao == null) {
          _shoppingItemDao = new ShoppingItemDao_DietDatabase_Impl(this);
        }
        return _shoppingItemDao;
      }
    }
