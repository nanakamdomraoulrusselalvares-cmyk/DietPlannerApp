...
public final class ShoppingItemDao_DietDatabase_Impl implements ShoppingItemDao {
  ...
  public ShoppingItemDao_DietDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
